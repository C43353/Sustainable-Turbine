# -*- coding: utf-8 -*-
"""
Created on Mon May  8 12:17:54 2023
...
Iteration 4 - Using blade profiles ranked in order of Cl/Cd
              Calculate twist angle from CLD profile in nodal_twist
              Using chord length from lecture notes * 4
...
for m, r in enumerate(segments):
    ...
    theta = nodal_twist(R, r, V0, c, alpha, omega, B, rho, fcl, fcd)
