# -*- coding: utf-8 -*-
"""
Created on Sat May  6 14:13:20 2023
...
Iteration 1 - Using blade profile similar to lecture notes one
              (don't have geometry of lecture one so placeholder)
              Using twist angle from lecture notes
              Using radius and chord length from lecture notes * 4
...
segments = 4 * np.array([4.5, 5.5, 6.5, 7.5, 8.5,
                         9.5, 10.5, 11.5, 12.5, 13.5,
                         14.5, 15.5, 16.5, 17.5, 18.5,
                         19.5, 20.3])

# Chord Length for Radial Position (m)
chords = 4 * np.array([1.63, 1.597, 1.54, 1.481, 1.42,
                       1.356, 1.294, 1.229, 1.163, 1.095,
                       1.026, 0.955, 0.881, 0.806, 0.705,
                       0.545, 0.265])

# Twist Angles for Raidal Position (degrees)
...
for i, p in enumerate(profiles):
    plt.text(segments[i], chords[i]-0.5, "CLD", va="bottom", ha="center")
